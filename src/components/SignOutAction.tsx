  ...
  return (
    <form action={handleLogout} style={{ width: '100%' }}>
      <button
        ...
        style={{ background: 'none', border: '1px solid var(--color-border-subtle)', width: '100%', textAlign: 'left', padding: 'var(--space-4)', borderRadius: 'var(--radius-lg)', cursor: 'pointer', display: 'flex', alignItems: 'center' }}
      >
